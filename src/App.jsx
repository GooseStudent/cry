    ...
    async function fetchAllData() {
      try {
        ...
        const weatherResponse = await axios.get(
          `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=${weatherApiKey}&units=metric&lang=ru`
        );
            ...
            <div className="info">
              ...
              {weatherData && (
                <div className="weather-info">
                  <div>
                    Погода сегодня: <br />
                    {weatherData.main.temp}°C  {weatherData.wind.speed} м/с  {weatherData.clouds.all}%
                  </div>
                  <img
